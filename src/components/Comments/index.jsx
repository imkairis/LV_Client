    ...
    <div className="w-full bg-white rounded-lg border p-1 md:p-3 m-10">
      ...
      <div className="flex flex-col gap-5 m-3">
        {comments?.map((comment, index) => (
          <CommentItem key={index} {...comment} setComments={setComments} />
        ))}
        ...
        <div>
          {isMyComment && (
            <Popup
              content={
                <ul>
                  <li className="cursor-pointer" onClick={handleEditComment}>
                    Chỉnh sửa
                  </li>
                  <li className="cursor-pointer" onClick={handleRemoveComment}>
                    Xóa
                  </li>
                </ul>
              }
